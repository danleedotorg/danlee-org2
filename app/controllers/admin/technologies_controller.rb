...
class TechnologiesController < Admin::RootController
  ...
  private
    ...
    def set_technology
      @technology = Technology.eager_load(:tech_category).find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def technology_params
      params.require(:technology).permit(:name, :tech_category_id)
    end
end
end
